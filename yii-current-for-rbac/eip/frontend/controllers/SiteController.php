...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
       ...
       if(isset($_GET['name'])){
        ...
        $hot = MeijuHot::find()->select(["meiju.mid", "meiju.title_cn", "meiju.title_en", "meiju.img"])
            ->join('LEFT JOIN', 'meiju', 'meiju_hot.mid = meiju.mid')
            ->where(['meiju_hot.type' => 'hot'])
            ->orderBy("meiju_hot.id")->limit(10)->asArray()->all();
